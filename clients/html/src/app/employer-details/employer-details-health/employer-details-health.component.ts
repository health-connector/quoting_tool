...
<div class="container mt-3">
  ...
  <div class="row">
    <div class="col-12 mt-2">
      <p class="main-text">
        ...
        <a href="https://www.mahealthconnector.org/business/employers/employee-choice" target="_blank">benefit models</a
        >.<br /><br />
        <i class="fas fa-sticky-note pr-2 fa-lg"></i>
        <strong
          >Note: The rates displayed for plans here represent 100% employer contribution to plan premium. You can choose
          to contribute less when you apply.
        </strong>
      </p>
      <strong
  ...
  <app-plan-filter [carrierPlans]="carriers" planType="health" />
</div>
